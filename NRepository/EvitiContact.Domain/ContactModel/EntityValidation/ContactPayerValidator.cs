...
{
    public partial class ContactPayerValidator : AbstractValidator<ContactPayer>
     {
    /// <summary>
    /// Initializes a new instance of the <see cref="ContactPayerValidator"/> class.
    /// </summary>
    public ContactPayerValidator()
     {
